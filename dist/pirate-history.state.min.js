 ...
 * 
 * @moment Monday, May 8, 2017 10:13 PM
 * @commit 613ff659326067620e4b7ee1f8bdd7c3d51b5587
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_source_browser_events_polyfill__ = __webpack_require__(11);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_source_common_is__ = __webpack_require__(12);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = parse;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_source_common_to_int__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_source_browser_path__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_source_browser_querystring__ = __webpack_require__(46);
...
function normalize(url, baseUrlObject) {
	if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_source_browser_path__["a" /* isAbsolute */])(Object(baseUrlObject).href)) {
		url = baseUrlObject.href + '/' + url;
	}
...
function parse(url, baseUrlObject) {
	...
	info.searchParams = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_source_browser_querystring__["a" /* parse */])(info.search);
	info.hash = $a.hash ? $a.hash.replace(/^#!?/, '') : '';
	info.port = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_source_common_to_int__["a" /* default */])($a.port) || defaultPorts[info.protocol] || null;
