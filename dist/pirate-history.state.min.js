 ...
 * 
 * @moment Sunday, May 7, 2017 9:24 PM
 * @commit fcd67ff27f46950cc6b56b71fc7cf2defd9db4e6
...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("pirate-history", [], factory);
	else if(typeof exports === 'object')
		exports["pirate-history"] = factory();
	else
		root["pirate-history"] = factory();
})(this, function() {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_source_browser_events_polyfill__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_source_browser_url_polyfill__ = __webpack_require__(48);
...
function updateStateList(URL, put) {
	put(__WEBPACK_IMPORTED_MODULE_1_source_browser_url_polyfill__["a" /* parse */](URL));
}
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_0__is_absolute__["a"]; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_source_common_a__ = __webpack_require__(9);




function isAbsolute(path) {
	if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_source_common_a__["a" /* default */])(path, 'String')) {
		var len = path.length;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__parse__ = __webpack_require__(47);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_0__parse__["a"]; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_source_common_a__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_source_common_to_int__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_source_browser_path__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_source_browser_querystring__ = __webpack_require__(46);
...
var defaultPorts = { http: 80, https: 443, ftp: 21, gopher: 70 };

function normalize(url, baseUrlObject) {
	if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_source_browser_path__["a" /* isAbsolute */])(Object(baseUrlObject).href)) {
...
function parse(url, baseUrlObject) {
	var info = {};
	...
	info.searchParams = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5_source_browser_querystring__["a" /* parse */])(info.search);
	info.hash = $a.hash ? $a.hash.replace(/^#!?/, '') : '';
	info.port = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_source_common_to_int__["a" /* default */])($a.port) || defaultPorts[info.protocol] || null;
...
var URL = function URL(url, baseUrlObject) {
	__WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_classCallCheck___default()(this, URL);

	if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_source_common_a__["a" /* default */])(url, 'URL')) return url;
	return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()(this, parse(url, baseUrlObject));
};
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__browser_history_state__ = __webpack_require__(42);
